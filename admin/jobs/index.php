...
?><div class="span9">
	...
	<ul class="nav nav-tabs" id="modTab" style="margin-bottom:0px;margin-left:5px;border-bottom: none;">
		<li class="active"><a id="tabJobTitles" href="#tabPageJobTitles">ชื่อตำแหน่งงาน</a></li>
		<li><a id="tabPayGrades" href="#tabPagePayGrades">อัตราค่าจ้าง</a></li>
		<li><a id="tabEmploymentStatus" href="#tabPageEmploymentStatus">สถานภาพการจ้างงาน</a></li>
	</ul>
